...
def write_local_data_to_stg(date, **kwargs):
...
def archive_processed_files(date, **kwargs):
...
dag = DAG(
    ...
    params={
        "date": Param(
            ...
            type="string",
            title="Pass date",
            description_md="Pass date in format DDMMYYYY",
        ),
    },
)
...
run_stg_to_dwh_pipeline_task = PythonOperator(
    task_id="stg_to_dwh_pipeline",
